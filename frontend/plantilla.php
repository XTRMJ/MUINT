...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="barandilla.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-eye fa-fw"></i>  Jefatura de análisis y explotación de la información ciudadana - datos de la barandilla</a>
